...
materials.PLA = [1240 61 47 160 160 35 25 50 3 10 6 2.549 0.35 0.49 0.13 1800 52]; % 3D - Printed PLA (FDM)
materials.Iglidur = [1300 54 37 458 458 31 22.5 50 3 10 6 1.7 0.3 0.25 0.24 1700 65]; % 3D - Printed Iglidur(FDM) ---> FRICTION COEF, THERM, CONDUC. AND SPECIFIC HEAT COEF IS UNCERTAIN AND WOULD BE GOOD TO EXPERIMENTALLY FIND
materials.nGen = [1200 50 35 285 285 30 21.5 50 3 10 6 1.8 0.3 0.3 0.19 1700 85]; % 3D - Printed ColorFabb nGen (FDM) ---> FRICTION COEF, THERM, CONDUC. AND SPECIFIC HEAT COEF IS UNCERTAIN AND WOULD BE GOOD TO EXPERIMENTALLY FIND
materials.XT = [1270 50 28 332 332 24 17.2 50 3 10 6 1.9 0.3 0.3 0.19 1700 90]; % 3D - Printed ColorFabb XT (FDM) ---> FRICTION COEF, THERM, CONDUC. AND SPECIFIC HEAT COEF IS UNCERTAIN AND WOULD BE GOOD TO EXPERIMENTALLY FIND
